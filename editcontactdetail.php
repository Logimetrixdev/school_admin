...
require_once("class/class.contactdetail.php");
$ajax=new PHPLiveX();
$contactdetail = new Contactdetail();
extract($_REQUEST);
$ajax->AjaxifyObjects(array("contactdetail"));  
...
$notify->Notify();
		if($submit=="Submit")
			$contactdetail->editcontactdetail('server',$vid);
		else
			$contactdetail->editcontactdetail('local',$vid);
?>
