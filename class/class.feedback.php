...
class Feedback{
	...
	function __construct(){
		 ...
		 function showallfeedback()
		 {
			?>
                       ...
                       <!--<div class="mws-panel-header">
                        ...
                        <div class="mws-panel grid_8">
                        <div class="mws-panel-header">
                        <span><i class="icon-table"></i>Feedback List</span>
                        </div>
		...
		$sql="select * from ".TBL_FEEDBACK." order by id" ;
		...
		$x=1;
			while($row = $this->db->fetch_array($result))
				...
				?>
					...
					onclick="javascript: if(confirm('Do u want to delete this record?')) { feedback.deletefeedback('<?php echo $row['id'];?>',{}) };" ><i class="icol-application-delete"></i></a>
