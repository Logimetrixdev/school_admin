...
include_once("class/class.editdirector_details.php");
include_once("fckeditor/fckeditor.php");
$director_obj = new Director_Details();
extract($_REQUEST);
...
$notify->Notify();
		if($submit=="Submit")
			$director_obj->editcontact_details('server');
		else
			$director_obj->editcontact_details('local');
?>
